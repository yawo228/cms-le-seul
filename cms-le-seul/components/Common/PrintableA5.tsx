...
const PrintableA5 = ({ ticket }: { ticket: Ticket }) => {
  ...
  return (
    <div className="p-10 max-w-[148mm] mx-auto !text-slate-800 font-sans h-[210mm] relative bg-white overflow-hidden flex flex-col border border-slate-200 shadow-sm">
      {/* Header Section */}
